    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.Vertical.CenterVertically) {
            Text(
                ...
                style = TextStyle(color = ColorProvider(FatumColors.TextPrimary), fontWeight = FontWeight.Bold, fontSize = 18.sp)
            )
        }
        Spacer(GlanceModifier.height(4.dp))
        Text(
            text = "Mejor racha activa",
            style = TextStyle(color = ColorProvider(FatumColors.TextMuted), fontSize = 11.sp)
        )
